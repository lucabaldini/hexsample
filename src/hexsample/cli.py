...
class CliArgumentParser(argparse.ArgumentParser):
    ...
    def add_recon_options(self, parser: argparse.ArgumentParser) -> None:
        ...
        group.add_argument("--eta_2pix_rad", default=0.127, type=float,
                           help="probit function sigma parameter for two pixel eta reconstruction")
        group.add_argument("--eta_3pix_rad0", default=0.513, type=float,
                           help="probit function offset parameter for three pixel radial" \
                           " component eta reconstruction")
        group.add_argument("--eta_3pix_rad1", default=0.141, type=float,
                           help="probit function sigma parameter for three pixel radial" \
                           " component eta reconstruction")
        group.add_argument("--eta_3pix_theta0", default=0.074, type=float,
                           help="exponential function prefactor for three pixel angular component" \
                           " eta reconstruction")
        group.add_argument("--eta_3pix_theta1", default=-0.5, type=float,
                           help="exponential function scale for three pixel angular component" \
                           " eta reconstruction")
        group.add_argument("--eta_3pix_theta2", default=-0.04, type=float,
                           help="Constant offset for three pixel angular component eta" \
                           "reconstruction")
